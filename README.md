...
4. Set the production domain in `app/layout.tsx` if you use a custom URL.
5. Deploy.
...
A placeholder comment is included in `app/layout.tsx` for adding Plausible or Vercel Analytics.
